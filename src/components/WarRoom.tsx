...
export default function WarRoom({ userId, onSignOut }: Props) {
  ...
  const { profile } = useTetherState(userId);

  // Check if the current session is anonymous (Ghost operative)
  useEffect(() => {
    if (!userId) return;
  ...
  // Phase C: Kill switch — sign out and return to EntryGate
  ...
  // ── Calibration Bunker (pre-War Room) ──────────────────────────────────────
  if (!isCalibrated) {
    return (
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-12 pointer-events-none">
          ...
          <div className="flex flex-col gap-4 pointer-events-auto">
            {/* Phase A: Ghost operative warning */}
        ...
        {/* Phase A: Identity upgrade modal */}
        {upgradeState !== 'idle' && (
            ...
            <div className="w-full max-w-md border border-yellow-900 bg-black p-10 shadow-[0_0_60px_-10px_rgba(234,179,8,0.15)]">
              ...
              {upgradeState === 'success' ? (
                ...
                <div className="space-y-6 text-center">
                  <p className="text-[10px] tracking-[0.4em] uppercase text-yellow-600">
                    IDENTITY_BOUND
                  </p>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-600 mt-2">
                      Anonymous UUID preserved. Zero data lost.
                    </p>
                  </div>
                  ...
                  {upgradeError && (
                    <p className="text-[10px] text-red-600 tracking-widest uppercase">
                      {upgradeError}
                    </p>
                  )}
